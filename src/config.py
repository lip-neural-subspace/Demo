...
from cloth_model import ClothSystem
...
def add_learning_args(parser):
    ...
    parser.add_argument("--MLP_hidden_layer_width", type=int, default=128)

def add_training_args(parser):
    parser.add_argument("--run_name", type=str, default="training")
    parser.add_argument("--n_train_iters", type=int, default=20000)
    parser.add_argument("--batch_size", type=int, default=256)
    parser.add_argument("--report_every", type=int, default=10)
    parser.add_argument("--lr_warm_up_iters", type=int, default=2000)
    parser.add_argument("--lr", type=float, default=1e-3)
    parser.add_argument("--lr_decay_every", type=int, default=10000)
    parser.add_argument("--lr_decay_frac", type=float, default=.8)
